...
const germanTranslations: TranslationMessages = {
  ...
  documentScanning: {
    ...
    initializationError: "Komponente konnte nicht geladen werden. Versuchen Sie ein anderes Gerät oder aktualisieren Sie Ihren Browser.",
...
const croatianTranslations: TranslationMessages = {
  ...
  documentScanning: {
    ...
    initializationError: "Komponenta se nije učitala. Pokušajte koristiti drugi uređaj ili ažurirajte preglednik.",
...
const spanishTranslations: TranslationMessages = {
  ...
  documentScanning: {
    ...
    initializationError: "Error al cargar el componente. Intenta usar otro dispositivo o actualizar tu navegador.",
